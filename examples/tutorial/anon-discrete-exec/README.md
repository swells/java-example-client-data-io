...
The following examples demonstrate data I/O on discrete executions of R scripts by [anonymous users](http://deployr.revolutionanalytics.com/documents/dev/api-doc/guide/introduction.html#introusers) on [stateless projects](http://deployr.revolutionanalytics.com/documents/dev/api-doc/guide/introduction.html#anonymousprojects).
...
- `EncodedDataIn` represents DeployR-encoded R object data sent as a data input.
...
- `EncodedDataOut` represents DeployR-encoded R object data available as a data output.
- `BinaryFileOut` represents a binary file from the working directory available as a data output.
- `GraphicsPlotOut` represents a plot generated by the graphics device available as a data output.
- `DataFileOut` represents a data file from the working directory available as a data output.
